 ...
 */
public abstract class RankBaseRS<T extends WorkerResourceDescription> extends ResourceScheduler<T> {
     ...
     */
    public RankBaseRS(Worker<T> w, JSONObject resJSON, JSONObject implJSON) {
